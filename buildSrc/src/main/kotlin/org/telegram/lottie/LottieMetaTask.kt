...
abstract class LottieMetaTask : DefaultTask() {
    ...
    fun run() {
        ...
        val parsed = rawResources.files
            ...
            .mapNotNull { f ->
                ...
                val mono = MONO_RAW_NAMES.contains(name)
                name to Triple(info.fps, info.frameCount, mono)
            }
    ...
    private companion object {
        ...
        // NixgramX: preserve MonoColorLottieList coverage (Telegram generator currently stubs mono=false).
        private val MONO_RAW_NAMES: Set<String> = setOf(
            "addone_icon",
            "auto_night_off",
            "boosts",
