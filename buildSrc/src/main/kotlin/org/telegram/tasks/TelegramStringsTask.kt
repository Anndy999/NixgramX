...
abstract class TelegramStringsTask : DefaultTask() {
    ...
    fun generate() {
        ...
        // Dynamic settings use LocaleController.getString(String), so their
        // R.string entries are not visible to static shrinking analysis. Keep
        // the full generated namespace: dropping any of it makes the runtime
        // resource-id lookup return null and leaves settings rows blank.
        generateResourceShrinkerKeepRules(
    ...
    private fun generateResourceShrinkerKeepRules(
        stringsDir: File,
        strings: Set<String>
    ) {
