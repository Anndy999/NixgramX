...
class PhotoViewerTransitionPathTest(unittest.TestCase):
    ...
    def test_no_reuse_delay_or_photoviewer_menu_workarounds_are_present(self):
        forbidden_viewer = (
        ...
        self.assertNotIn("glassMenuMinimumItems", self.viewer)
        self.assertNotIn("calculateGlassMenuGeometryWidth", self.viewer)
        self.assertNotIn("setGlassMenuMinimumItems", self.viewer)
