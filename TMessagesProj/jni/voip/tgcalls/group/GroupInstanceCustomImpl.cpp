...
public:
    ...
    void start() {
        ...
        stringStream << "WebRTC-DataChannel-Dcsctp/Enabled/"
            "WebRTC-Audio-Allocation/min:" << _outgoingAudioBitrateKbit << "kbps,max:" << _outgoingAudioBitrateKbit << "kbps/"
        ...
        // InitFieldTrialsFromString keeps the pointer; the string must not be destroyed.
        static std::string webrtcInitStr;
        webrtcInitStr = stringStream.str();
